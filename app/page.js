  ...
  return (
    ...
    <div className="bg-grey-900 flex flex-col h-screen justify-between">
      ...
      <div className="mb-auto h-10 my-6">
        ...
        <p className="ml-4 w-11/12 text-white text-l">A collection of 50 CryptoPhunk remixes inspired equally by CryptoPhunk artwork and the sampling commonly found in hip-hop production, (Ph)remix is the next iteration of Phunk Remixes by <a href="https://x.com/0xDuplo" target="_blank" className="text-[#00dfff]">Duplo</a>. While the first remixes we all manually created, (Ph)remixes are computer assisted, with pixels randomly placed in a specified region (or regions) of the origional 24x24 grid, starting with <a href="https://www.vphree.io/cryptophunk/2174" target="_blank" className="text-[#00dfff]">CryptoPhunk 2174</a>.</p>
        <br/>
        <p className="ml-4 w-11/12 text-white text-l mb-6">To <a href="https://ethscriptions.com/" target="_blank" className="text-[#00dfff]">Ethscribe</a> a (Ph)remix just click the image and confirm the transaction from your wallet. Simple as that.</p>
